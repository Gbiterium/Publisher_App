      ...
      <div class="card-body py-md-3 px-md-5">
        <ValidationObserver ref="form">
          <form>
            ...
            <div
              class="row mt-3 contributor"
              v-for="(el, index) in contributorsData"
              :key="index"
            >
              <div class="col-md-4">
                <ValidationProviderWrapper
              ...
              <b-icon-x-lg
                class="fs-12 pointer text-grey cancel-icon"
            ...
            <div class="row mt-3">
              <div class="col-md-3 add-more">
                <button
                  v-if="contributorsData.length > 0"
                  class="btn btn-transparent px-3 py-2"
                  @click.prevent="addContributor"
                >
                  Add Another
                </button>
                <button
            ...
            <div class="row mt-3">
              <div class="col-md-5">
                ...
                <div class="date">
                  <v-date-picker v-model="publication_date" mode="date">
            ...
            <div class="mt-2 fs-14">
              ...
              <label class="ml-2"
                >I own the copyright and I hold the necessary publishing
                rights.<span class="text-blue"> Learn more</span></label
              >
            </div>
            <div class="row">
...
export default {
  ...
  data() {
    return {
      ...
      author_name: "",
      contributor: "",
      contributorsData: [{ contributor: "", full_name: "" }],
      full_name: "",
      categories: "",
      keywords: "",
      grade_level: "",
    ...
    async handleSubmit() {
      ...
      const data = {
        ...
        publication_date: this.publication_date
          ? this.formatDate(this.publication_date)
          : "",
