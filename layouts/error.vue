  ...
  <div class="d-flex justify-content-center align-items-center bg-white p-5">
    <div class="mt-5">
      ...
      <div class="d-flex justify-content-center mt-5">
        <button @click="$router.go(-1)" class="btn btn-text py-2 px-3 goback mx-2">
          Go Back
        </button>

        <NuxtLink to="/publisher/analytics" class="btn btn-text py-2 px-3 homepage mx-2">
...
export default {
  layout(context) {
    ...
    //   return "authWithoutTopbar";
    // }
    // if(word2.every(word => context.route.path.includes(word))) {
    //   return "student";
    // } 
    return "default";
  },
